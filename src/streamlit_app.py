...
def get_relevant_refs(query):
    ...
    refs = vector_store.similarity_search(
        query=query, k=5, filter={"lastmod_year": {"$gte": current_year - 1}}
    )
    return refs
...
st.info(
    "Hi! I am Buck-AI-Guide, your undergrad CSE research advisor. I know everything about the OSU CSE program. Ask me anything!"
)
...
if user_query is not None and user_query != "":
    ...
    with st.chat_message("AI"):
        response_stream, ref_urls = get_response_stream(
